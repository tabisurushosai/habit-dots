...
- [x] T008: Premiumゲート(7日トライアル trial_start_ts + Stripe Checkout URL)。無料は習慣3つ、Premiumで無制限+ストリーク履歴
- [x] T009: npm run build を通し ts/lint を解消
- [x] T010: release/habit-dots.zip 生成(manifest+icons+_locales+dist、node_modules除外)
